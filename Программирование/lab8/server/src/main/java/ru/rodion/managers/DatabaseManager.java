...
//    }
    ...
    public boolean deleteByWeaponType(User user, Weapon weapon){
        try (Connection connection = getConnection();
             PreparedStatement ps = connection.prepareStatement(DatabaseCommands.deleteByWeaponType)) {
                ps.setString(1, weapon.toString());
