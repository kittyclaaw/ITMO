...
import ru.rodion.commands.Command;
...
public class CommandManager {
     ...
     * @throws ru.rodion.exceptions.NoCommandException        такая команда отсутствует
     * @throws ru.rodion.exceptions.IllegalArgumentsException неверные аргументы команды
     * @throws ru.rodion.exceptions.CommandRuntimeException   команда выдала ошибку при исполнении
     * @throws ru.rodion.exceptions.ExitException             команда вызвала выход из программы
     */
