...
public class FilterWorker {
    ...
    public void parsePredicate(int row, List<?> values){
        switch (row) {
            ...
            case 5 -> this.addPredicate(5, (o) -> values.contains(o.getAchievements()));
            case 6 -> this.addPredicate(6, (o) -> values.contains(o.getHeight()));
            case 7 -> this.addPredicate(7, (o) -> values.contains(o.getWeaponType()));
